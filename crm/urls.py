...
urlpatterns = [
    ...
    # 增加跟进记录
    url(r'consult_record/add/', consultant.consult_record, name='add_customer_record'),
    ...
    # 展示缴费记录
    url(r'payment_record_list/(?P<customer_id>\d+)/', consultant.PaymentList.as_view(), name='payment_record'),

    # 添加缴费记录
    url(r'payment/add/(?P<customer_id>\d+)/', consultant.payment, name='add_payment'),

    # 编辑缴费记录
    url(r'payment/edit/(?P<edit_id>\d+)/', consultant.payment, name='edit_payment'),
    ...
    # 编辑班级
    url(r'class/edit/(?P<edit_id>\d+)/', teacher.classes, name='edit_class'),
